      ...
      for (const [countryCode, countryData] of Object.entries(providers.results)) {
        ...
        for (const monetizationType of monetizationTypes) {
          ...
          for (const provider of providerList) {
            try {
              // Skip provider upsert - providers are managed by sync edge functions
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              {/* Ad Banner - Middle */}
              <div className="mb-8">
                <AdBanner position="person_middle" />
              </div>
        ...
        {/* Ad Banner - Bottom */}
        <div className="mt-8">
          <AdBanner position="person_bottom" />
        </div>
      </div>
    </div>
  )
