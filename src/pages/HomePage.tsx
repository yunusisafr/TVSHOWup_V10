...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      {/* Ad Banner - Top */}
      <div className="px-3 sm:px-6 lg:px-8 py-4">
        <AdBanner position="home_top" className="max-w-7xl mx-auto" />
      </div>
      ...
      <div className="pb-8 pt-6 sm:pt-8">
        <div className="space-y-8">
          ...
          <div className="px-3 sm:px-6 lg:px-8">
            <AdBanner position="home_middle" className="max-w-7xl mx-auto" />
          </div>
          ...
          {/* Ad Banner - Bottom */}
          <div className="px-3 sm:px-6 lg:px-8 py-4">
            <AdBanner position="home_bottom" className="max-w-7xl mx-auto" />
          </div>
