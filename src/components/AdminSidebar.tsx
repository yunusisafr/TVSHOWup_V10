...
import { LayoutDashboard, Film, Users, Settings, FileText, LogOut, Database, PlusCircle, Megaphone } from 'lucide-react';
...
const AdminSidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: `${baseAdminPath}/ads`, icon: Megaphone, label: 'Ad Management', active: true },
